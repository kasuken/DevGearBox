...
{
    public partial class UrlEncodeDecodeCtl : UserControl
    {
        ToolsServices toolsServices;

        public UrlEncodeDecodeCtl()
        {
            InitializeComponent();
        ...
        {
            txtResult.Text = toolsServices.UrlEncode(txtSource.Text);
        }
        ...
        private void btnDecode_Click(object sender, EventArgs e)
        {
            try
            {
                txtResult.Text = toolsServices.UrlDecode(txtSource.Text);
            }
            catch (Exception ex)
            {
